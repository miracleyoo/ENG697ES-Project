...
extern int* virtual_to_physical_list; // A list which map virtual address to physical address
extern int* physical_to_virtual_list;  // A list which map physical address to virtual address
